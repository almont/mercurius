...
var merx = {
    ...
    createOverlay: function () {
        ...
        if (!document.getElementById("m_iframe")) {
            ...
            iframe.style.width = "712px";
            iframe.style.height = "465px";
            iframe.style.left = "50%";
            iframe.style.top = "50%";
            iframe.style.marginLeft = "-375px";
            iframe.style.marginTop = "-235px";
        ...
        if (!document.getElementById("m_bt_close")) {
            ...
            img.style.left = "50%";
            img.style.top = "50%";
            img.style.marginLeft = "319px";
            img.style.marginTop = "-252px";
